...
public class Tarot_Base_Draw_Card extends CustomCard {
    /**
     * 技能牌 --抽牌
     */
    ...
    //卡牌在游戏中的id
    public static final String ID = "Tarot_Base_Draw";
    //卡牌显示的名称
    public static final String NAME = "Tarot_Base_Draw";
    //卡牌下方的描叙内容。
    public static final String DESCRIPTION = "Tarot_Base_Draw";
    //卡牌的费用。
...
//        this.baseBlock = 6;//基础格挡值，除升级以外无任何其他加成. this.block为有敏捷等加成的格挡值.
    ...
    public AbstractCard makeCopy() {
        return new Tarot_Base_Draw_Card();
    }
